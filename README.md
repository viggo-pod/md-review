...
Reviews ONE Markdown document per invocation across 17 document scenarios (PRD, API spec, GDD, TDD, ADR, …) or in generic mode.
...
- **17 scenarios** — each with its own required-content checklist (acceptance criteria, 5W1H, endpoint contracts, error codes, test cases, …).
...
| `<scenario>` | One of the 17 scenarios above; omit for generic mode |
