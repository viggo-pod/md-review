---
name: md-review
description: 'Review Markdown documents for logic, completeness, references, redundancy, and formatting across generic and scenario-specific documents (PRD, ADR, ADD, API, BRD, MRD, FSD, GDD, GDO, TDD, LDD, Concept, Intent, Capability, Feature, Research, TLD, TCD, DECQ, Issue, GPR).'
